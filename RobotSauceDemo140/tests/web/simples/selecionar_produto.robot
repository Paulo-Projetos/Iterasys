...
${browser}    Edge        #Chrome        # navegador a ser usado
${timeout}    10000ms                    # Variavel que aplica tempo de espera automaticamente nas mudanças de paginas e ouros.
...
Dado que acesso o site SauceDemo
    ...
    Set Browser Implicit Wait    5000ms                               # Define espera implicita do navegador.
...
Entao sou direcionado para a pagina do carrinho
    Wait Until Element Contains    css=.title    Your Cart                        # Tempo de espera - Substitui as duas linhas "Should be" e "Wait Until is visible" 
